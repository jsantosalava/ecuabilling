                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                <div class="col-md-6">
                                <legend>INGRESAR CALLTYPE</legend>
                                <form action="" id="guardarCalltype" class="mb-2">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select id="segcalltype" required class="form-control">
                                        <option value="" selected>SELECCIONAR</option>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input class="form-control" id="calltype" type="text" placeholder="" required>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <ul class="list-group" class="mb-2">
                                        <legend>LISTA CALLTYPE</legend>
                                        <div id="mostrarCalltype"></div>
                                    </ul>
                                </div>
                            </div>
                            </div>
