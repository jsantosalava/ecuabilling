...
<body>
<input type="hidden" id="extension" value="<?php $AGENT = substr($agente, 7, 4); echo $AGENT; ?>">
<input type="hidden" id="callid" value="<?php echo $callid; ?>">
    			
	<input type="hidden" id="tipo_llamada" value="1">
