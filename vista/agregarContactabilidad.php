...
if ( isset( $_SESSION[ 'INGRESO' ] ) && $_SESSION[ 'INGRESO' ] == 'YES'  ) {
  ?>
    ...
    <head>
        ...
        <title>AGREGAR CONTACTABILIDAD</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                <div class="col-md-6">
                                <legend>INGRESAR CONTACTABILIDAD</legend>
                                <form action="" id="guardarContactabilidad" class="mb-2">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="nombreContactabilidad">CONTACTABILIDAD</label>
                                            <input class="form-control" id="nombreContactabilidad" type="text" placeholder="" required>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <ul class="list-group" class="mb-2">
                                        <legend>LISTA DE CONTACTABILIDAD</legend>
                                        <div id="mostrarContactabilidad"></div>
                                    </ul>
                                </div>
                            </div>
                            </div>
    ...
    <script src="../js/contactabilidad.js"></script>
