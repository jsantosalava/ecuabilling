                                    ...
                                    <form id="editarUsuario" action="">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input class="form-control" id="usuarioUs" type="text" required>
                                            </div>
                                            <div class="form-group col-md-2">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input class="form-control" id="passUsuario" type="password" required>
                                            </div>
                                            <div class="form-group col-md-3">
                                               
                                                <label for="repassUsuario">REPETIR CONTRASEÑA</label>
                                                <input class="form-control" id="repassUsuario" type="password" required>
                                            </div>
                                            </div>
