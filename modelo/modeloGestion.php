...
WHERE
    ...
    function mostrarInfo($id)
    {
        ...
        $sql = "SELECT cedula_info,fecha_info,mes_info,nombre_info,correo_info,contrato_info,rango_info,director_info,gerente_info,supervisor_info,asesor_info,nombre_sucursal FROM informacion_cliente left join sucursal on sucursal_info = idsucursal where estado_info = 1 and cedula_info = '$id'";
