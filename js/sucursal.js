...
function agregarCampania() {
    ...
    $.ajax({
        url: '../controlador/controladorSucursal.php',
        cache: false,
        type: 'POST',
        ...
        success: function(Resp) {
            ...
            if (Resp === '0') {
                ...
                for (var i = 0; i < gasto.length; i++) {
                    ...
                    html += '<li class="list-group-item d-flex justify-content-between align-items-center" >' + gasto[i][1] + '->'+gasto[i][0]+'<div class="btn-group" role="group" aria-label="Basic example">';
